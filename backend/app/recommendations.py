...
def _deal_context(deal: Deal, recent_bbcs: list[BorrowingBaseCertificate]) -> dict:
    return {
        ...
        "latest_borrowing_base": deal.latest_borrowing_base,
        "latest_availability": deal.latest_availability,
        "fccr_minimum": deal.fccr_minimum,
        ...
        "financials": {
            "trailing_revenue": deal.trailing_revenue,
            "trailing_ebitda": deal.trailing_ebitda,
            "unfinanced_capex": deal.unfinanced_capex,
            "cash_taxes_paid": deal.cash_taxes_paid,
            "distributions": deal.distributions,
            "scheduled_debt_service": deal.scheduled_debt_service,
            "annual_rent_and_leases": deal.annual_rent_and_leases,
        },
        "recent_bbc_history": [
            {
                "period_end": b.period_end, "availability": b.availability,
                "dilution_pct": b.dilution_pct, "borrowing_base": b.borrowing_base,
            }
